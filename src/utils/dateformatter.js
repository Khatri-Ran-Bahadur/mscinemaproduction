...
export const getMalaysiaDate = () => {
  const now = new Date();
  const mytString = now.toLocaleString("en-US", {
...
export const movieShowDateTime = (showDateTime) => {
  if (showDateTime) {
    try {
      const val = showTime;
...
export const formatMalaysiaShowDateTime = (value) => {
  if (!value) return "Show Time";
...
export const formatMalaysiaDate = (value) => {
  if (!value) return "-";
...
export const formatMalaysiaTime = (value) => {
  if (!value) return "-";
