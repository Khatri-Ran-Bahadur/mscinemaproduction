...
/**
 * Resend Ticket Email (Admin)
 * Fixes bookingData reference error and handles empty stats safely.
 */
export const resendTicketEmail = async (to, ticketData, corporateInfoPassed = null) => {
  const bookingData = ticketData; // Fix ReferenceError
  ...
  // Safe fallback logic
  if (ticketDetails.length === 0 && (!seatDisplay || seatDisplay.length === 0) && bookingData) {
    const seats = bookingData?.seats || [];
    const selectedTickets = bookingData?.selectedTickets || [];
    const seatGroups = {}; 
    ...
    seats.forEach((seat, index) => {
      ...
      if (seatNo) {
        if (!seatGroups[ticketType]) seatGroups[ticketType] = [];
        seatGroups[ticketType].push(seatNo);
        ticketDetails.push({
            TicketType: ticketType,
            SeatNo: seatNo,
              ...
              <div style="padding: 30px;">
                ...
                <div style="margin-top: 40px; padding-top: 20px; border-top: 1px dashed ${colors.border};">
                  ...
                  <div style="font-size: 10px; color: #666; line-height: 1.6; text-align: justify;">
                    ...
                    <strong style="color: #888;">REGISTRATION</strong>
                    <ol>
                      <li>You may be asked to provide Personal Information to MS Cinemas before purchasing any movie ticket, goods or services from this Website...</li>
                      <li>All Personal Information MS Cinemas collects from this Website will be maintained in accordance with MS Cinema's Privacy Policy.</li>
                      <li>You acknowledge that if you do not register as a member of this Website, parts of this Website designed for registered members may not be accessible to you.</li>
                      <li>MS Cinemas will use its reasonable endeavors to maintain the security of any Personal Information that you provide.</li>
                      <li>MS Cinemas may use techniques designed to identify fraudulent activities on the Website.</li>
                      <li>You agree that MS Cinemas may cancel your registration as a member and/or refuse you access to this Website at any time in its sole discretion.</li>
                    </ol>
                  </div>
                </div>
