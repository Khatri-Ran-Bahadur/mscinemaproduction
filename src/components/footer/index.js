                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-8 md:mb-12">
                    ...
                    <div className="col-span-2 md:col-span-1 text-center md:text-left">
                        ...
                        <div className="flex justify-center md:justify-start gap-4 md:gap-6 mb-6 md:mb-8">
                            {/* Facebook */}
                            <a href="https://www.facebook.com/profile.php?id=100087528683670" target="_blank" className="w-10 h-10 rounded-full border border-[#3a3a3a] flex items-center justify-center hover:border-[#FFCA20] transition">
                            ...
                            {/* Instagram */}
                            <a href="https://www.instagram.com/mscinemas/" target="_blank" className="w-10 h-10 rounded-full border border-[#3a3a3a] flex items-center justify-center hover:border-[#FFCA20] transition">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-[#FAFAFA]">
                            ...
                            {/* TikTok */}
                            <a href="https://www.tiktok.com/@mscinemas?lang=en" target="_blank" className="w-10 h-10 rounded-full border border-[#3a3a3a] flex items-center justify-center hover:border-[#FFCA20] transition">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-[#FAFAFA]">
