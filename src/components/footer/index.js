        ...
        <footer className="bg-[#1a1a1a] text-[#FAFAFA]">
            <div className="container mx-auto px-4 md:px-6 py-8 md:py-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-8 md:mb-12">
                    ...
                    {/* Right Column - Connect with us (Centered on Mobile, Right on Desktop) */}
                    <div className="col-span-2 md:col-span-1 text-center md:text-left">
                        ...
                        <div className="flex justify-center md:justify-start gap-4 md:gap-6 mb-6 md:mb-8">
                            {/* Facebook */}
                            <a href="#" className="w-10 h-10 rounded-full border border-[#3a3a3a] flex items-center justify-center hover:border-[#FFCA20] transition">
