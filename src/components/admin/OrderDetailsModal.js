          ...
          <div className="md:col-span-2">
            <div className="flex flex-wrap gap-4 items-center justify-between bg-[#222] p-4 rounded-lg border border-[#333]">
              <div>
                ...
                <div
                  className={`inline-flex items-center gap-2 px-3 py-1 rounded-md border text-sm font-medium ${getStatusColor(order.status)}`}
                >
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-bold text-[#FFCA20]">
            ...
            <div className="bg-[#2a2a2a] p-4 rounded-lg border border-[#3a3a3a] grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm">
                  {formatMalaysiaDate(order.createdAt)}
                </p>
              </div>
              <div>
                <p className="text-xs text-[#888]">Updated At</p>
                <p className="text-white text-sm">
                  {formatMalaysiaDate(order.updatedAt)}
                </p>
              </div>
            </div>
          </div>
